...
{
    public partial class frm_report_equipement_sorties : MetroForm
    {
        public frm_report_equipement_sorties()
        {
            InitializeComponent();
        }
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cnx.State == ConnectionState.Closed)
                    cnx.Open();
                const string requete = "liste_equipements_sorties";
                ...
                var rpt = new rep_liste_equipements_sortis();
                var dtset = new DataSet();
                da.Fill(dtset, "liste_equipements_sorties");
