...
{
    public partial class Data_Depot
    {
        Data_Parametres prms = new Data_Parametres();
        public void enregistrer_depot(string code_depot, string designation_depot,DataTable dx)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("designation_depot", SqlDbType.NVarChar)).Value = designation_depot;
        ...
        public void supprimer_depot(string code_depot, DataTable dx)
        {
        ...
        //    finally { cnx.Close(); cnx.Dispose(); }
        //}
        public void afficher_depot(DataTable dt)
        {
            SqlConnection cnx = new SqlConnection(prms.ToString());
            try
            {
